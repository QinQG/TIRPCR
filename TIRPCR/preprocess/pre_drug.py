...
def parse_args():
    ...
    parser.add_argument('--input_data_dir', default=r'', help='input data directory')
    parser.add_argument('--output_data_dir', default=r'', help='output data directory')
...
def ndc2rxing():
    mapping = np.loadtxt(fname=r"", delimiter=',', dtype='str', skiprows=1,
                         usecols=(3, 4),encoding='utf-8')
