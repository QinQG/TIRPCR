...
def parse_args():
    ...
    parser.add_argument('--data_dir', type=str,
                        default="")
    parser.add_argument('--pickles_dir', type=str, default=r'')
    parser.add_argument('--treated_drug_file', type=str,default="ZYCF0019")
    parser.add_argument('--controlled_drug', choices=['ATC','random'], default='random')
    parser.add_argument('--controlled_drug_ratio', type=int, default=10)
    ...
    parser.add_argument('--med_hidden_size', type=int, default=32)
    parser.add_argument('--diag_hidden_size', type=int, default=32)
    ...
    parser.add_argument('--outputs_lr', type=str, default="")
    parser.add_argument('--save_db', type=str, default="")
...
def main(args):
    ...
    if args.controlled_drug == 'random':
        ...
        ATC2DRUG = pickle.load(open(os.path.join(args.pickles_dir,''), 'rb'))
        DRUG2ATC = pickle.load(open(os.path.join(args.pickles_dir,''), 'rb'))
